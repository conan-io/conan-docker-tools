...
if __name__ == "__main__":
    ...
    try:
        ...
        subprocess.check_call(["docker", "exec", container, "cp", "/tmp/bin/libllvm-unwind.so.1.0", "/usr/lib/x86_64-linux-gnu/libllvm-unwind.so.1"])
        ...
        subprocess.check_call(["docker", "exec", container, "/tmp/bin/foobar_c_libcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/bin/foobar_cpp_libstdcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/bin/foobar_c_libstdcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/bin/foobar_cpp_libstdcpp11"])
        subprocess.check_call(["docker", "exec", container, "/tmp/bin/foobar_c_libstdcpp11"])
