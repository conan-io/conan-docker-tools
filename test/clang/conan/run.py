...
if __name__ == "__main__":
    ...
    try:
        ...
        subprocess.check_call(["docker", "exec", container, "/tmp/project/foobar_cpp_libcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/project/foobar_c_libcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/project/foobar_cpp_libstdcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/project/foobar_c_libstdcpp"])
        subprocess.check_call(["docker", "exec", container, "/tmp/project/foobar_cpp_libstdcpp11"])
        subprocess.check_call(["docker", "exec", container, "/tmp/project/foobar_c_libstdcpp11"])
