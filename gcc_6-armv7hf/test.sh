...
sudo docker exec conangcc6-armv7hf conan install gtest/1.8.1@bincrafters/stable -s arch=armv7hf -s compiler=gcc -s compiler.version=6 -s compiler.libcxx=libstdc++ --build && \
