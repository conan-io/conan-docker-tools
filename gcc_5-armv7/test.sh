...
sudo docker exec conangcc5-armv7 conan install gtest/1.8.0@lasote/stable -s arch=armv7 -s compiler=gcc -s compiler.version=5 -s compiler.libcxx=libstdc++ --build && \
