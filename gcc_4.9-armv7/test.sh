...
sudo docker exec conangcc49-armv7 conan install gtest/1.8.1@bincrafters/stable -s arch=armv7 -s compiler=gcc -s compiler.version=4.9 -s compiler.libcxx=libstdc++ --build && \
