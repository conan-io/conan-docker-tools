...
sudo docker exec gcc8-armv7hf conan install gtest/1.8.0@conanio/stable -s arch=armv7hf -s compiler=gcc -s compiler.version=7 -s compiler.libcxx=libstdc++ --build && \
