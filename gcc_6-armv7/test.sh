...
sudo docker exec conangcc6-armv7 conan install gtest/1.8.1@bincrafters/stable -s arch=armv7 -s compiler=gcc -s compiler.version=6 -s compiler.libcxx=libstdc++ --build && \
