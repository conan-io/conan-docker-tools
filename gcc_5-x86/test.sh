...
sudo docker exec gcc5-x86 conan install gtest/1.8.1@binrcrafters/stable -s arch=x86 -s compiler=gcc -s compiler.version=5 -s compiler.libcxx=libstdc++ --build && \
