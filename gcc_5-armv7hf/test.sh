...
sudo docker exec conangcc5-armv7hf conan install gtest/1.8.0@lasote/stable -s arch=armv7hf -s compiler=gcc -s compiler.version=5 -s compiler.libcxx=libstdc++ --build && \
