...
sudo docker exec conangcc7-mingw conan install zlib/1.2.11@ -s os=Windows -s arch=x86_64 -s compiler=gcc -s compiler.version=7 -s compiler.libcxx=libstdc++ --build && \
